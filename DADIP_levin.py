...
parser.add_argument('--save_path', type=str, default="results/levin/se2/", help='path to save results')
...
files_source = glob.glob(os.path.join('datasets/levin/im4_kernel4_img.png'))
files_source.sort()
...
for f in files_source:
    ...
    scheduler = MultiStepLR(optimizer, milestones=[800, 1400, 2000], gamma=0.5)  # learning rates
